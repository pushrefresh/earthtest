...
* The Framework
*/
class Compound_Framework_Core {

	function __construct() {
		do_action( 'wpscom_framework_include_modules' );
	}
	...
	public function open_container( $element = 'div', $id = null, $extra_classes = null, $properties = null ) {
		...
		if ( ! is_null( apply_filters( 'wpscom_container_class', $this->defines['container'] ) ) ) {
			$default_classes = explode( ' ', apply_filters( 'wpscom_container_class', $this->defines['container'] ) );

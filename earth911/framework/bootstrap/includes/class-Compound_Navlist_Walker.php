...
/*
 * Class Name: Compound_Navlist_Walker
 ...
 *
 * Compound_Nav_Walker example output:
 *   <li class="menu-home"><a href="/">Home</a></li>
 *   <li class="menu-sample-page"><a href="/sample-page/">Sample Page</a></li>
 */
class Compound_Navlist_Walker extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 2, $args = array(), $id = 0 ) {
		...
		$item_html = apply_filters( 'wpscom_wp_nav_menu_item', $item_html );
		$output .= $item_html;
	}

...
/**
 * Class Name: Compound_Nav_Walker
 ...
 */
class Compound_Nav_Walker extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
			...
			if ( $wpscom_settings['menu_title_attribute'] == 1 ) {
			 ...
			 */
			if ( ! empty( $item->attr_title ) && $wpscom_settings['menu_title_attribute'] != 1 ) {
				$item_output .= '<a'. $attributes .'><span class="el-icon-' . esc_attr( $item->attr_title ) . '"></span>&nbsp;';
			} 
			elseif ( ! empty( $item->description ) && $wpscom_settings['menu_title_attribute'] == 1 ) {
